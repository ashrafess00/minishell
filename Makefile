...
#    Updated: 2023/05/30 16:29:50 by aessaoud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c utils.c utils2.c free_me.c free_me2.c manage_envs.c manage_envs2.c $(TOKENIZE_IT_SRCS) $(PARSE_IT_SRCS) $(EXECUTE_IT_SRCS) expand_me.c expand_me2.c
