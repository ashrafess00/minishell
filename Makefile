...
#    Updated: 2023/05/22 12:20:56 by kslik            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c printers_will_be_delted_later.c utils.c utils2.c free_me.c free_me2.c manage_envs.c $(TOKENIZE_IT_SRCS) $(PARSE_IT_SRCS) $(EXECUTE_IT_SRCS) expand_me.c expand_me2.c
