...
#    Updated: 2023/06/09 20:09:25 by aessaoud         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c utils.c utils2.c free_me.c free_me2.c manage_envs.c manage_envs2.c manage_envs3.c herdoc.c expand_me.c expand_me2.c $(TOKENIZE_IT_SRCS) $(PARSE_IT_SRCS) $(EXECUTE_IT_SRCS) 
